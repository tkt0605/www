...
INSERT INTO `account_emailaddress` VALUES (1,'takato.komada2005@outlook.jp',1,1,1),(2,'kmada_0605@icloud.com',1,1,2),(3,'takato_2005@icloud.com',1,1,3),(4,'csta24064@g.nihon-u.ac.jp',1,1,4);
...
INSERT INTO `accounts_account` VALUES (1,'駒田隆人','image/sample.jpg','icon/5770f01a32c3c53e90ecda61483ccb08.jpg','・・・・','・・・・','・・・・','2024-10-12 09:52:52.925110',1),(2,'komada0605','image/sample.jpg','icon/5770f01a32c3c53e90ecda61483ccb08.jpg','・・・・','・・・・','・・・・','2024-10-12 11:26:55.504660',2),(3,'takato','image/sample.jpg','icon/5770f01a32c3c53e90ecda61483ccb08.jpg','・・・・','・・・・','・・・・','2024-10-12 12:01:54.206047',3),(4,'kmd_4064','image/sample.jpg','icon/5770f01a32c3c53e90ecda61483ccb08.jpg','・・・・','・・・・','・・・・','2024-10-12 12:44:15.570068',4);
...
INSERT INTO `accounts_customuser` VALUES (1,'pbkdf2_sha256$870000$ngHGiBeRny29zPsozRqryn$YuwQ9dVy8CXkh2+xx2QP0YgAySoD+n8eyNMOt+97doU=','2024-10-13 12:09:07.628393',1,'takato.komada2005@outlook.jp','駒田隆人','駒田','隆人',1,1,'2024-10-12 09:52:52.000000'),(2,'pbkdf2_sha256$870000$EwclcFCjvegJfCY4ifITMj$zHKFHBVBvktIR3q1HuiqmRO84Xsh/Jxi9jWIWq0U7kk=','2024-10-13 11:15:32.648843',0,'kmada_0605@icloud.com','komada0605','駒田','龍弥',1,0,'2024-10-12 11:26:55.000000'),(3,'pbkdf2_sha256$870000$7oeXNpDzJl5EUJ6ZqAyWWr$axqe0bwFylXNpjpRVJPkAxcii4JaZ3wARtihtJsZ74E=','2024-10-12 12:02:17.000000',0,'takato_2005@icloud.com','takato','駒田','隆人',1,0,'2024-10-12 12:01:53.000000'),(4,'pbkdf2_sha256$870000$jfEayyDGXRW1xxutCUdXyV$C9s2cRvqUxaZgg6ncsCDoh9p1wPz96LmffL0MoEyvVM=','2024-10-12 12:44:33.200983',0,'csta24064@g.nihon-u.ac.jp','kmd_4064','駒田','隆人',1,0,'2024-10-12 12:44:15.300654');
...
INSERT INTO `django_admin_log` VALUES (1,'2024-10-12 11:25:53.646421','1','takato.komada2005@outlook.jp',2,'[{\"changed\": {\"fields\": [\"First name\"]}}]',9,1),(2,'2024-10-12 11:39:09.785121','2','kmada_0605@icloud.com',2,'[{\"changed\": {\"fields\": [\"First name\", \"Last name\"]}}]',9,1),(3,'2024-10-12 12:45:14.221192','3','takato_2005@icloud.com',2,'[{\"changed\": {\"fields\": [\"First name\", \"Last name\"]}}]',9,1),(4,'2024-10-13 12:10:56.153641','1','Example One',3,'',1,1),(5,'2024-10-13 12:25:35.981555','2','Example One',3,'',1,1);
...
INSERT INTO `django_session` VALUES ('az8yc22t00hkzgvo9yr9987liybgb8wl','.eJxVkMFugzAMht_FZxQlISEZp6n3PcE0IZN4gwIxIkHbVPXdV7peevvl__NnyRfAEHhPpcO9DJTKGLCMnLqFysAxQ_t-gf8MLayY8zdvESrAAq1y2nutauNEc8sv0lVAC47zDS04YWEx8YIRtZT2lfcyM0_ivML1o4L7wW7PtHXj4VbwNOsxTJSOIp4xfbEInMo29uJAxKPN4o0jzacH-yQYMA-3bevlp0VTB-8bcmiDCc4bgx69VdjEWgUre3J1T15TT1pH65U0Vtlorb1LM-V8_IR-1nH7hVZe_wAmK2aX:1szxPH:-my4F5YrClwyVh7QemQ1LDDn4gimd7r4ZCRofdlZeb4','2024-10-27 12:09:07.635371');
...
CREATE TABLE `flexblock_group_comanager` (
  ...
  `customuser_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `flexblock_group_comanager_group_id_account_id_4b0ef76b_uniq` (`group_id`,`customuser_id`),
  KEY `flexblock_group_coma_account_id_ab06ef16_fk_accounts_` (`customuser_id`),
  CONSTRAINT `flexblock_group_coma_customuser_id_9213e268_fk_accounts_` FOREIGN KEY (`customuser_id`) REFERENCES `accounts_customuser` (`id`),
...
INSERT INTO `flexblock_rootauth` VALUES (1,1,1,2,1,0);
...
-- Dump completed on 2024-10-13 12:43:06
